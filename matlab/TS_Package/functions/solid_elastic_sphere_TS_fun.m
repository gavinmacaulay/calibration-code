...
%% 
function    [para, out]=solid_elastic_sphere_TS_fun(freq_range,freq_spec,scale,n,target_index,proc_flag,D,T,P,S,cw,rhow,ave_BW,para)
...
otherwise   % specifying the material properties for other type of materials
%    rho=para.rho;   
%    cc=para.cc;
%    cs=para.cs;
